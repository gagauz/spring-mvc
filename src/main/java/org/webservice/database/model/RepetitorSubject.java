...
import org.webservice.database.model.enums.PupilCategory;
...
import org.webservice.utils.Filters;
...
import static org.webservice.utils.CollectionUtils.filterByMask;
import static org.webservice.utils.CollectionUtils.getMask;

@Entity
@Table(name = "REPETITOR_SUBJECT")
@TypeDefs({
        @TypeDef(name = "bitSet", typeClass = BitSet.class),
        @TypeDef(name = "enumSetOf.PupilCategory", typeClass = EnumSetType.class, parameters = {@Parameter(name = CollectionType.CLASS, value = "org.webservice.database.model.enums.PupilCategory")})})
